 ...
 * Date: $Date: 2007-05-11 20:14:45 +0800 (五, 2007-05-11) $
 *
...
public class RDPClientChooser {
	...
	public boolean RunNativeRDPClient(String[] args) {
		...
		if (os.startsWith("Mac OS X")) {
			if (new File(
					"/Applications/Remote Desktop Connection/Remote Desktop Connection")
					.exists()) {
				logger
						.info("MAC OS X Microsoft Remote Desktop Connection exists");
				try {
